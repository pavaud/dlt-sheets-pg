...
def load_pipeline_with_ranges(spreadsheet_url_or_id: str, range_names: Sequence[str]) -> None:
    """
...
def load_with_table_rename_and_multiple_spreadsheets(spreadsheet_url_or_id: str, range_names: Sequence[str]) -> None:
...
if __name__ == "__main__":
    url_or_id = "1YzZ4UfikEOseSE27R8CZO3DlJBmiSMK_vz5Gei5uoe8"
    range_names = ["Impots_par_Salaires"]
